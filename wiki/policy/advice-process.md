...
1.  Finally, in order to put all of this in order: an [**onboarding/training document**](../policy/Unicorn-onboarding.md) to train everyone on the process of things? Meaning, self-management is not self-evident and we all need upskilling on this :). That or we make mandatory the reading of reinventing organizations :P
